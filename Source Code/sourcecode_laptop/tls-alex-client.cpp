...
void *writerThread(void *conn)
{
	...
	{
		char ch;
		printf("Command (f=forward, b=reverse, l=turn left, r=turn right, w=FORWARDMACRO, s=BACKWARDSMACRO, a=LEFTMACRO, d=RIGHTMACRO, t=TURBOMACRO, x=stop, c=clear stats, g=get stats q=exit)\n");
		scanf("%c", &ch);
